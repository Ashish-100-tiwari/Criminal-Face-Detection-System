...
class Face_recognition:
    def __init__(self,root):
        ...
        img_left = Image.open(r"C:\Users\hp\Documents\vscode's\.vscode\criminal face recognation system\college_images\face_detector1.jpg")
        ...
        img_right = Image.open(r"C:\Users\hp\Documents\vscode's\.vscode\criminal face recognation system\college_images\facial_recognition_system_identification_digital_id_security_scanning_thinkstock_858236252_3x3-100740902-large.jpg")
    ...
    def face_recog(self):
        def draw_boundray(img,classifier,scaleFactor,minNeighbour,color,text,clf):
            ...
            for (x,y,w,h) in feature:
                ...
                if confidence>77:
                    cv2.putText(img,f"Cellno.:{r}",(x,y-55),cv2.FONT_HERSHEY_COMPLEX,0.8,(255,255,255),3)
                    cv2.putText(img,f"Name:{n}",(x,y-30),cv2.FONT_HERSHEY_COMPLEX,0.8,(255,255,255),3)
                    cv2.putText(img,f"Type of crime:{d}",(x,y-5),cv2.FONT_HERSHEY_COMPLEX,0.8,(255,255,255),3)
                    cv2.putText(img,f"Criminal_id:{i}",(x,y-75),cv2.FONT_HERSHEY_COMPLEX,0.8,(255,255,255),3)
