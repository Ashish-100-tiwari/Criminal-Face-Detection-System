...
# #frame
        ...
        dev_lbl=Label(main_frame,text="-> Mukul Gupta",font=("time new roman",13,"bold"),bg="white",fg="blue")
        dev_lbl.place(x=0,y=145)
        dev_lbl=Label(main_frame,text="->Priyanshu Singh",font=("time new roman",13,"bold"),bg="white",fg="blue")
        dev_lbl.place(x=0,y=180)
