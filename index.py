...
# student button
        img4=Image.open(r"C:\Users\hp\Documents\vscode's\.vscode\criminal face recognation system\college_images\c.jpg")
        ...
        b1_1=Button(bg_img,text="Criminal Details",command=self.student_details,cursor="hand2",font=("time new roman",15,"bold"),bg="white",fg="black")
